...
class IPControllerTest extends TestCase
{
    ...
    public function testCreateObject()
    {
      # Create IP objects with correct and incorrect IP
        ...
        $this->assertInstanceOf("\Ylva\IPcontrol2\IPcontrol", $IPc2);

        $IPc3 = new IPcontrol("113.133.17198");
        $this->assertInstanceOf("\Ylva\IPcontrol2\IPcontrol", $IPc3);
    }
    ...
    public function testgetRes()
    {
        ...
        $this->assertInstanceOf("\Ylva\IPcontrol2\IPcontrol", $IPc);
